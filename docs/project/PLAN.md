...
| M2 | 核心阅读流、批注笔迹持久化与 AI 交互联调 (R01–R09, R14, R16, R17) | 原生阅读与手写流打通，笔迹持久化与乐观锁闭环，AI 助学流式接入 | **IN_PROGRESS (已启动，M2-BE 进行中)** |
| M3 | R10 全文学习视图、R11–R12、R15 完整能力与多轮上下文 | 全部 P0 与 V0.1 范围回归，两路笔记管理与离线/隐私恢复验证 | TODO |
